  ...
  export default class VerifyPhone extends Vue {
    ...
    rules: Record<string, any> = {
      ...
      phone: [
        {
          required: true,
          message: this.$t('validate.wrong-phone-number'),
          trigger: 'blur'
        }
      ]
    }
    ...
    created(): void {
      ...
      this.form.country = currentCountry.isoCode
    }
