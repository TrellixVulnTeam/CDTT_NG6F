<template>
  <base-popup name="popup-lock" class="popup-lock" width="480px" :close="handleClose">
    ...
    <div class="content">
      {{ $t('inventory.inventory-detail.title-lock') }} <span class="text-semibold">{{ detail.itemName }} #{{ detail.itemCode }}</span>  {{ $t('inventory.inventory-detail.of') }} <span class="text-semibold">{{ detail.fullName }}</span>
