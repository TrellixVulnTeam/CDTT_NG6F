    ...
    <el-form class="form-setting">
      <div class="content-left">
        ...
        <div class="be-flex align-center jc-space-between switch-item">
          ...
          <div class="right">
            <el-switch v-model="form.isTop" active-value="YES" inactive-value="NO" active-color="#129961"> </el-switch>
          </div>
        </div>
        <div class="be-flex align-center jc-space-between switch-item">
          <div class="left">
          ...
          <div class="right">
            <el-switch v-model="form.isHot" active-value="YES" inactive-value="NO" active-color="#129961"> </el-switch>
          </div>
        </div>
      </div>
      ...
      <div class="content-right">
        ...
        <el-form-item :label="$t('label_position-hot-nft')">
          <el-input v-model="form.hotPosition" :disabled="form.isTop === 'NO'" :placeholder="$t('label_position-hot-nft')" @keypress.native="onlyNumber($event)" />
        </el-form-item>
      </div>
    </el-form>
  </div>
